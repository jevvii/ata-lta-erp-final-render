...
async function run() {
  ...
  try {
    ...
    console.log('\n✅ Remote database data successfully cleared (schemas and ALL users preserved).');
  } finally {
    await client.end();
  }
}
